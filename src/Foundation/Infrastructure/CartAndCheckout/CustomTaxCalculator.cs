...
namespace Foundation.Infrastructure.CartAndCheckout
{
    public class CustomTaxCalculator // : ITaxCalculator
    {
        ...
        public Money GetSalesTax(IEnumerable<ILineItem> lineItems, IMarket market, IOrderAddress shippingAddress, Currency currency) => throw new NotImplementedException();
    }
}